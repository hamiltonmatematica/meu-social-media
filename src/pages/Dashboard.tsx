...
export default function Dashboard() {
  ...
  return (
    <div className="bg-slate-900 text-slate-100 flex h-screen overflow-hidden">
      ...
      />
      {/* BEGIN: Sidebar */}
      <aside className={`hidden md:flex flex-col bg-slate-800 border-r border-slate-700 transition-all duration-300 relative ${isSidebarOpen ? 'w-64' : 'w-20 items-center'}`}>
      ...
      {/* BEGIN: MainContent */}
      <main className="flex-1 flex flex-col overflow-y-auto bg-slate-950 pb-20 md:pb-0 relative">
        {/* BEGIN: TopHeader */}
      ...
      <div 
        className="md:hidden fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-xl border-t border-white/10 flex justify-around items-end z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.3)] pb-safe"
